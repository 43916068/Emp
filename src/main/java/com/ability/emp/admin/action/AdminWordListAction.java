...
public class AdminWordListAction {
	...
	public String queryAll(int pageSize,int pageNumber) throws Exception {
		...
		List<AdminWordEntity> data = wordService.queryAll();		
	...
	public String wordedit(HttpServletRequest request,HttpServletResponse response){
		return "wordedit";
	}
	...
	public String updateWord(@ModelAttribute("word") AdminWordEntity word, Model model) {
