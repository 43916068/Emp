...
public class ConnUtil {
     ...
     */
    public static String getResponseString(HttpURLConnection conn) throws IOException, DemoExceptionUtil {
     ...
     * @throws DemoExceptionUtil http 的状态码不是 200
     */
    public static byte[] getResponseBytes(HttpURLConnection conn) throws IOException, DemoExceptionUtil {
        ...
        if (responseCode != 200) {
            ...
            throw new DemoExceptionUtil("http response code is" + responseCode);
        }
